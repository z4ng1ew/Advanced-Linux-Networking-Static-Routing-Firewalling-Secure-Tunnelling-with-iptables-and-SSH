...
###  1. Установка Apache2 на машины r1, r2 и ws22
...
### 2. Изменение файла ports.conf на ws22 и r1
...
### 3. Запуск Apache-сервера на ws22 и r1
...
###  4. Очистка iptables на r2 и установка политики по умолчанию
...
###  5. Проверка недоступности ping между r1 и ws22
...
###  6. Добавление разрешающего правила для ICMP
...
###  7. Повторная проверка соединения после разрешения ICMP
...
###  9. Настройка DNAT для проброса порта 8080 на ws22
...
###  10. Проверка SNAT с помощью telnet и tcpdump
...
###  11. Проверка DNAT — доступ к Apache на ws22 через r2
...
### 12. Прослушка интерфейса enp0s8 на ws22 с tcpdump
