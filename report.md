...
![alt text](новая_новая_конфигурация_нетплан_r2.png) 
![alt text](новая_новая_конфигурация_нетплан_продолжение_r2.png) 
![alt text](iptables_-t_nat_-L_-n_-v_на_r2.png) 
---
...
### 10. Перед тестированием рекомендуется отключить сетевой интерфейс NAT (его наличие можно проверить командой ip a) в VirtualBox, если он включен.

![alt text](отключаем_НАТ_на_r2.png) 
![alt text](проверка_отключения_НАТ_на_r2.png)
---



### 11. Проверил соединение по TCP для SNAT: 
💬 * Для этого с ws22 подключился к серверу Apache на r1 командой:
telnet [адрес] [порт]*

![alt text](Проверка_SNAT_с_ws22.png) 
...
![alt text](Проверить_подмену_IP-адреса.png)
---
...
![alt text](Проверяем_соединение_по_TCP_для_DNAT.png) 
---
